...
public class FunctionsWS extends DB {
    ...
    public Response functions(@Context HttpHeaders headers, @FormParam("nr_pessoa") String nr_pessoa, @FormParam("departamento_id") String departamento_id, @FormParam("tipo") String tipo, @FormParam("via") String via) {
